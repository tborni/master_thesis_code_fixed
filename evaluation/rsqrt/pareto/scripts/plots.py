#!/usr/bin/env python3
"""Render the rsqrt Pareto figures from the combined CSVs.
...
# Marker per DSP count. Covers the DSP values actually present in the data
# ({0, 3, 6, 9}); anything unexpected falls back to "X" (and is flagged).
