#!/usr/bin/env python3
"""Plot the Softmax N-sweep LUT usage against N, with an affine linear fit.
...
Note that the resources sweep covers a narrower N range than the accuracy sweep
(N = 2 .. 1024 here), so this figure spans fewer points than the accuracy ones;
the affine fit is over exactly the sampled resource points.
