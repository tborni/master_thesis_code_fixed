module rsqrt_lookup_tb;
	...
	localparam int unsigned  MIN_ADDR_WIDTH            =  1;
	localparam int unsigned  MAX_ADDR_WIDTH            = 10;
	localparam int unsigned  STEP_ADDR_WIDTH           =  3;
	localparam int unsigned  MIN_WORD_WIDTH            =  1;
	localparam int unsigned  MAX_WORD_WIDTH            = 13;
	localparam int unsigned  STEP_WORD_WIDTH           =  6;
	localparam int unsigned  MIN_SUSTAINABLE_INTERVAL  = 1;
	localparam int unsigned  MAX_SUSTAINABLE_INTERVAL  = 13;
