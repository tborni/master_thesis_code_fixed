module softmax_accuracy_tb;
	...
	localparam config_t  CONFIGS[NUM_CONFIGS] = '{
		...
		mk_config(exp_bit_hacking_cfg(), rec_bipartite_cfg(.newton(1), .word_width(18), .aw0(5), .aw1(6), .aw2(6))),	// exp[0] x rec[3]
		...
		mk_config(exp_lookup_cfg   (.word_width(8),  .addr_width(8)), rec_bipartite_cfg(.newton(1), .word_width(18), .aw0(4), .aw1(6), .aw2(6))),	// exp[1] x rec[3]
		...
		mk_config(exp_bipartite_cfg(.word_width(15), .aw0(2), .aw1(5), .aw2(5)), rec_bipartite_cfg(.newton(1), .word_width(18), .aw0(4), .aw1(6), .aw2(6))),	// exp[2] x rec[3]
		mk_config(exp_splitting_cfg(.word_width(22), .aw0(6), .aw1(5), .aw2(6)), rec_bipartite_cfg(.newton(0), .word_width(11), .aw0(2), .aw1(3), .aw2(3))),	// exp[3] x rec[0]
		mk_config(exp_splitting_cfg(.word_width(22), .aw0(6), .aw1(5), .aw2(6)), rec_lookup_cfg   (.newton(0), .word_width(16), .addr_width(11))),	// exp[3] x rec[1]
		mk_config(exp_splitting_cfg(.word_width(22), .aw0(6), .aw1(5), .aw2(6)), rec_lookup_cfg   (.newton(1), .word_width(8),  .addr_width(9))),	// exp[3] x rec[2]
		mk_config(exp_splitting_cfg(.word_width(22), .aw0(6), .aw1(5), .aw2(6)), rec_bipartite_cfg(.newton(1), .word_width(18), .aw0(4), .aw1(6), .aw2(6)))	// exp[3] x rec[3]
	};
